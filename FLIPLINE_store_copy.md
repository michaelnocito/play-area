# FLIPLINE — CrazyGames Submission Copy

Paste-ready copy for the developer-portal submission form. Tone: calm, premium, skill-respecting
(matches the game's "fairness + the long way home" identity). Broad audience — no pandering.
...
One tap to understand. A long way to master.
...
## Tags
runner, one button, gravity, arcade, reflex, skill, endless runner, casual, minimalist, flip, dodge, high score, one-tap, hypercasual

## Category / Genre
Arcade · Casual (Endless Runner)

## Notes for the submission
- Single self-contained `index.html`, SDK from CDN — well under the 50MB / 1,500-file basic-launch cap.
- Controls cover mouse, keyboard, and touch. Landscape on desktop; mobile prompts to rotate to landscape.
- PEGI-12 safe (abstract, no violence/text/objectionable content).
